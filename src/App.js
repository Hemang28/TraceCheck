...
function App() {
  ...
  useEffect(() => {
    (async () => {
      ...
      const options = {
        clientId:
          "BMlPdry8FpY80fT_cbuDJ8mjAM62Bo_6HnZxvfAE6ZaNLsEQaH2Nr8iqFap3uZCufIm5xfKWBZYklVjfCUr3vS0",
  ...
  const logout = async () => {
    try {
      ...
      console.log("Sign Out",signOutInfo);
      setUserData({
        provider: "",
        address: "",
        signer: "",
          ...
          element={
            <>
              ...
              <Routes>
                ...
                <Route
                  path="/IA-Dashboard"
                  element={<IssuingAuthorityDashboard userData={userData} />}
                ></Route>
                <Route
                  path="/User-Dashboard"
